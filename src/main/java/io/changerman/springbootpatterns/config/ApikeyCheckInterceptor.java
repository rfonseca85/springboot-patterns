package io.changerman.springbootpatterns.config;
...
public class ApikeyCheckInterceptor implements HandlerInterceptor {
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler,
        ...
        System.out.println("x-api-key used again... adding this info to database, so I can bill the usage" + request.getHeader("x-api-key"));
    }
}
